      ...
      <div className="flex-1 divide-y divide-outline-variant/30 px-4 pb-4">
        {conversations.length > 0 ? (
              ...
              <div className="flex-grow min-w-0">
                <div className="flex justify-between items-center mb-1">
                  <p className="text-sm font-black text-on-surface group-hover:text-primary transition-colors truncate">
                    {conv.customer?.fullName || 'Khách hàng ẩn danh'}
                  </p>
                ...
                <div className="flex gap-2">
                  {conv.messages && conv.messages[0]?.senderType === 'bot' ? (
          ...
          <div className="flex flex-col items-center justify-center h-full py-10 opacity-30">
            ...
            <p className="text-xs font-black uppercase tracking-widest">Chưa có hội thoại nào</p>
          </div>
        )}
      </div>
    </div>
